function MFMTestWindow(filename,ti,tf,sr,f)
	...
	(nch,td,AECG,fetal_annot) = loadData(filename,nsd,sr,bw,fw)
...
heart_rateAcum,QRScell_pos_smoothAcum,SMIAcum,gini_measureAcum) = initializationAcum(i,td,fetal_annot,AECG,AECG_clean,
...
QRSfcell_valueAcum,heart_rate_fetoAcum,QRSfcell_pos_smoothAcum,SMIAcum,gini_measureAcum) = concatVar(i,td,fetal_annot,AECG,AECG_clean,
AECGm_ica,AECGm_sort,AECG_residual,QRSm_pos,QRSm_value,heart_rate_mother,SVDrec,
