function fetalSubstractionModule(AECG_residual,heart_rate_mother,nch,sr,ts)

	# Include function files
	include("makeIcaFetal.jl")
	include("qrsFetalSelector.jl")
	include("giniCoefficient.jl")
